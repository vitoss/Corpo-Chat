...
public class InputBoxShouldBeEmptyAfterPosting {
	...
	@Test
	public void testInputBoxShouldBeEmptyAfterPosting() throws Exception {
		...
		Thread.sleep(1000);
		assertEquals("", selenium.getText("css=input.msg"));
	}
